...
String serverName = "192.168.32.101";  // Corrected server name format
...
String sendPhoto() {
  ...
  if (client.connect(serverName.c_str(), serverPort)) {
    ...
    client.println("Content-Type: multipart/form-data; boundary=PechayDetection");
    client.println();
    client.print(head);
